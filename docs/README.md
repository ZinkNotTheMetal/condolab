...
- [Paperless-ngx Compose stack](host-setup/paperless-ngx-compose-stack.md)
- [SearXNG Compose stack](host-setup/searxng-compose-stack.md)
- [CloudBeaver Compose stack](host-setup/cloudbeaver-compose-stack.md)
...
9. optionally stand up the Paperless-ngx stack for document OCR and archive
   management
10. optionally stand up the SearXNG stack for private metasearch and future AI
   search backends
11. optionally stand up the CloudBeaver stack for browser-based database access
12. continue with standards and service-specific setup
